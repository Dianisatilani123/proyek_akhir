...
def main():
    ...
    with st.sidebar:
        ...
        if st.button("Prediksi"):
            ...
            # Membuat tabel biodata kandidat
            pdf.set_font("Arial", size=10)
            pdf.cell(100, 10, txt="Fitur", border=1, align="C")
            pdf.cell(100, 10, txt="Nilai", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="City", border=1, align="C")
            pdf.cell(100, 10, txt=f"{city}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="City Development Index", border=1, align="C")
            pdf.cell(100, 10, txt=f"{city_development_index:.3f}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Gender", border=1, align="C")
            pdf.cell(100, 10, txt=f"{gender}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Relevent Experience", border=1, align="C")
            pdf.cell(100, 10, txt=f"{relevent_experience}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Enrolled University", border=1, align="C")
            pdf.cell(100, 10, txt=f"{enrolled_university}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Education Level", border=1, align="C")
            pdf.cell(100, 10, txt=f"{education_level}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Major Discipline", border=1, align="C")
            pdf.cell(100, 10, txt=f"{major_discipline}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Experience", border=1, align="C")
            pdf.cell(100, 10, txt=f"{experience}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Company Size", border=1, align="C")
            pdf.cell(100, 10, txt=f"{company_size}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Company Type", border=1, align="C")
            pdf.cell(100, 10, txt=f"{company_type}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Last New Job", border=1, align="C")
            pdf.cell(100, 10, txt=f"{last_new_job}", border=1, align="C")
            pdf.ln(10)
            pdf.cell(100, 10, txt="Training Hours", border=1, align="C")
            pdf.cell(100, 10, txt=f"{training_hours}", border=1, align="C")
            pdf.ln(10)
