...
city_development_index = st.slider("City Development Index", 0.0, 0.926, 0.5, step=0.001)
...
experience = st.slider("Experience", 0, 21, 5)  # Adjusted the slider range to match the transformation
